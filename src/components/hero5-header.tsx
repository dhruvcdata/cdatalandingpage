...
const menuItems = [
    ...
    },
    {
        ...
        subMenu: [
            ...
            { title: 'Data Migration', href: '/services/data-migration', description: 'Seamlessly transfer data between systems with minimal downtime.' },
            { title: 'Data and AI Strategy', href: '/services/data-and-ai-strategy', description: 'Develop a roadmap for data and AI initiatives aligned with business goals.' },
