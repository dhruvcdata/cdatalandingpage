...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className="bg-background py-12 pt-[20vh] px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-8 text-gray-300">
                    <section>
                        ...
                        <p>
                            ...
                            to ensure that you're happy with any changes. By using our Site, you're agreeing to be bound
                    ...
                    <section>
                        ...
                        <p>
                            We may also collect information on how the Site is accessed and used ("Usage Data"). This Usage Data
                    ...
                    <section>
                        ...
                        <p className="mb-4">CData uses the collected data for various purposes:</p>
                        <ul className="list-disc pl-6 mb-4 space-y-2">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mb-4 space-y-2">
                            ...
                            <li>Protect and defend the rights or property of CData</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mb-4 space-y-2">
                            ...
                            <li>The right to data portability - the right to be provided with a copy of the information we have on you in a structured, machine-readable format</li>
                            <li>The right to withdraw consent - the right to withdraw your consent at any time where CData relied on your consent to process your personal information</li>
                        </ul>
                    </section>
