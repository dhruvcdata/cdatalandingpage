        ...
        <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
          <div className="relative mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
              {/* <div className="inline-block rounded-full bg-blue-100 px-3 py-1 text-sm font-medium text-blue-500 mb-4">Health & Data Innovation</div> */}
              <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-8 xl:text-7xl bg-ble-500 from-blue-500 to-purple-500 bg-clip-text tex-transparent">Transform Health & Wellness with Data Intelligence</h1>
      ...
      <section className="py-16 md:py-16 bg-background to-indigo-900  px-6">
        <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-12">
          <div className="grid gap-6 md:grid-cols-2 md:gap-12">
            <h2 className="text-4xl font-medium text-blue-500">Data-Powered Healthcare for Better Patient Outcomes</h2>
      ...
      <section className="py-12 bg-background md:py-10">
        <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
          <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
            <h2 className="text-balance text-4xl font-medium lg:text-5xl bg-blue-500 from-blue-500 to-indigo-500 bg-clip-text text-transparent">Comprehensive Health Data Solutions</h2>
          ...
          <div className="relative mx-auto grid max-w-4xl sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-3 p-8 rounded-xl border border-gray-900 bg-background shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-medium text-blue-500">Clinical Analytics</h3>
              </div>
              <p>Turn EHR data into actionable insights that improve clinical decision-making and patient outcomes.</p>
            </div>
            <div className="space-y-3 p-8 rounded-xl border border-gray-900 bg-background shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-2 mb-4">
                <div className="rounded-full bg-background border border-gray-800 p-3">
                ...
                <h3 className="text-lg font-medium text-blue-500">Wellness Monitoring</h3>
              </div>
              <p>Track and analyze fitness and wellness metrics to develop personalized health programs.</p>
            </div>
            <div className="space-y-3 p-8 rounded-xl border border-gray-900 bg-background shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-2 mb-4">
                <div className="rounded-full bg-background border border-gray-800 p-3">
                ...
                <h3 className="text-lg font-medium text-blue-500">HIPAA Compliance</h3>
              </div>
              <p>Ensure data security and regulatory compliance with our specialized healthcare solutions.</p>
            </div>
            <div className="space-y-3 p-8 rounded-xl border-2 border-gray-900 bg-background shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-medium text-blue-500">Population Health</h3>
              </div>
              <p>Analyze health trends across patient populations to identify risks and intervention opportunities.</p>
            </div>
            <div className="space-y-3 p-8 rounded-xl border-2 border-gray-900 bg-background shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-2 mb-4">
                <div className="rounded-full bg-background border border-gray-800 p-3">
              ...
              <p>Optimize scheduling, resource allocation, and patient flow with data-driven insights.</p>
            </div>
            <div className="space-y-3 p-8 rounded-xl border-2 border-gray-900 bg-background shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-2 mb-4">
                <div className="rounded-full bg-background border border-gray-800 p-3">
                ...
                <h3 className="text-lg font-medium text-blue-500">Predictive Health</h3>
              </div>
              <p>Leverage AI to predict health issues before they develop and enable preventive care.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto p-6 rounded-xl overflow-hidden relative">
          ...
          <div className="relative z-10">
            <div className="mb-10">
              ...
              <p className="text-xl text-blue-200">Driving better health outcomes through innovative data strategies and advanced analytics.</p>
            </div>
      ...
      <section className="py-16 md:py-16 bg-background rounded-3xl mx-6">
        <div className="mx-auto max-w-5xl px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-semibold md:text-4xl mb-4 textblue-500">Success Stories</h2>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="bg-background border-2 border-gray-800 p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-medium text-lg text-blue-500">Regional Hospital Network</h3>
              </div>
              ...
              <div className="bg-background border border-gray-800 p-3 rounded-lg">
                <p className="text-sm text-blue-700 font-medium">50% improvement in clinical workflow efficiency</p>
              </div>
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-y-12 px-2 lg:grid-cols-[1fr_auto]">
            ...
            <div className="divide-y divide-blue-500 sm:mx-auto sm:max-w-lg lg:mx-0">
              <div className="pb-6">
                <h3 className="font-medium text-blue-500">How do you ensure HIPAA compliance?</h3>
              ...
              <div className="py-6">
                <h3 className="font-medium text-blue-500">Can we integrate with existing EHR systems?</h3>
              ...
              <div className="py-6">
                <h3 className="font-medium text-blue-500">What ROI can we expect from healthcare analytics?</h3>
